...
func main() {
	...
	smsService := service.NewSMSService(provider, smsLogRepo, logger)
	notificationService := service.NewNotificationService(recipientRepo, templateRepo, claimRepo, smsService, logger)
	alertService := service.NewAlertService(recipientRepo, subscriptionRepo, claimRepo, smsService, cfg.ConfirmTimeout, logger)
	statusService := service.NewStatusService(recipientRepo, claimRepo, cfg.ConfirmTimeout)
